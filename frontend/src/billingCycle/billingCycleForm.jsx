            ...
            <form role="form" onSubmit={handleSubmit}>
                <div className="box-body">
                    ...
                    <Field name="month" component={LabelAndInput}
                      type="number" label="Mês" cols="12 4" placeholder="Informe o mês" readOnly={readOnly} />
                    <Field name="year" component={LabelAndInput} 
                      type="Number" label="Ano" cols="12 4" placeholder="Informe o ano" readOnly={readOnly} />
